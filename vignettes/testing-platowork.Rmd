...
The R package is available from GitHub here: [https://github.com/lassehjorthmadsen/platowork](https://github.com/lassehjorthmadsen/platowork). It can be installed directly from Github with `devtools::install_github("https://github.com/lassehjorthmadsen/platowork")`.
